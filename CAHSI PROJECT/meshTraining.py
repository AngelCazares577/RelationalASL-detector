...
def categoryIs(y, num_classes=None):
    """Convert a class vector (integers) to binary class matrix. tensorflow.keras seems to not be working
    so I just used functions native to numpy to replace to_categorical"""
